...
def floyd_warshall(adjacency_matrix):
    ...
    adj_mat_copy = adjacency_matrix.astype(int, order='C', copy=True)
...
def gen_edge_input(max_dist, path, edge_feat):
    ...
    path_copy = path.astype(int, order='C', copy=True)
    edge_feat_copy = edge_feat.astype(int, order='C', copy=True)
